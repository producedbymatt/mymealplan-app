...
export const breakfastRecipes: Meal[] = [
  ...
  },
  {
    ...
    recipe: {
      ...
      instructions: [
        "Dice sweet potato and vegetables",
  ...
  },
  {
    ...
    recipe: {
      ...
      instructions: [
        "Mix waffle batter with protein powder",
        "Cook in waffle iron",
        "Top with butter",
  ...
  },
  {
    ...
    recipe: {
      ...
      instructions: [
        ...
        "Heat chickpeas",
        "Slice avocado",
        "Assemble bowl and drizzle with oil"
      ],
      prepTime: "10 minutes",
      cookTime: "20 minutes"
    }
  ...
  },
  {
    ...
    recipe: {
      ingredients: [
        ...
        "2 eggs (140 cal)",
        "1 cup sautéed spinach (40 cal)",
        "1/4 avocado (80 cal)",
        "1 tbsp olive oil (120 cal)",
        "Everything bagel seasoning (5 cal)"
      ],
      instructions: [
        "Cook farro",
        "Sauté spinach",
  ...
  },
  {
    ...
    recipe: {
      ...
      instructions: [
        "Cook oats and quinoa separately",
        "Combine with almond milk",
        "Add diced apple",
